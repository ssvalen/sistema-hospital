...
DB_CONFIG = {
    ...
    'database': os.getenv('DB_NAME', 'keycloak_db'),
...
WATCH_DIR_BODEGA = '/app/uploads/bodega'  
WATCH_DIR_MEDICAMENTO = '/app/uploads/medicamento'
LOG_DIR = "/app/logs"
...
VALID_BODEGA_FILES = ['bodega.csv', 'bodegas.csv']
VALID_MEDICAMENTO_FILES = ['medicamento.csv', 'medicamentos.csv']
...
BODEGA_COLUMNAS = ['nombre_bodega', 'ubicacion'] 
MEDICAMENTO_COLUMNAS = ['nombre_comercial', 'principio_activo', 'unidad_medida']