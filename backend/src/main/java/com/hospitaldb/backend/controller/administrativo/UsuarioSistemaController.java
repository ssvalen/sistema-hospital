...
public class UsuarioSistemaController {
        ...
        public ResponseEntity<EntityResponse<List<UsuarioSistemaListDTO>>> getAll(HttpServletRequest request) {
                ...
                return ResponseEntity.ok(
                                EntityResponse.success(usuarios, "Usuarios obtenidos exitosamente",
        ...
        public ResponseEntity<EntityResponse<PaginatedResponse<UsuarioSistemaListDTO>>> getAllPaginated(
                ...
                return ResponseEntity.ok(
                                EntityResponse.success(response, "Usuarios obtenidos exitosamente",
                                                request.getRequestURI()));
        }

        @GetMapping("/{id}")
        public ResponseEntity<EntityResponse<UsuarioSistemaDetailDTO>> getById(@PathVariable Long id,
                        HttpServletRequest request) {
        ...
        public ResponseEntity<EntityResponse<UsuarioSistemaDetailDTO>> create(
                ...
                return ResponseEntity.status(HttpStatus.CREATED).body(
                                EntityResponse.success(created, "Usuario creado exitosamente",
                                                request.getRequestURI()));
        }
        ...
        public ResponseEntity<EntityResponse<UsuarioSistemaDetailDTO>> update(
                        ...
                        @Valid @RequestBody UsuarioSistemaRequestUpdateDTO requestDTO,
                        HttpServletRequest request) {
                ...
                return ResponseEntity.ok(
                                EntityResponse.success(updated, "Usuario actualizado exitosamente",
                                                request.getRequestURI()));
        }
        ...
        public ResponseEntity<EntityResponse<Void>> delete(@PathVariable Long id, HttpServletRequest request) {
                ...
                return ResponseEntity.ok(
                                EntityResponse.success(null, "Usuario eliminado exitosamente",
                                                request.getRequestURI()));
        }
        ...
        public ResponseEntity<EntityResponse<UsuarioRol>> asignarRol(
                ...
                return ResponseEntity.status(HttpStatus.CREATED).body(
                                EntityResponse.success(asignacion, "Rol asignado exitosamente",
                                                request.getRequestURI()));
        }
        ...
        @GetMapping("/activos")
        public ResponseEntity<EntityResponse<List<UsuarioSistemaListDTO>>> getUsuariosActivos(
                        HttpServletRequest request) {
                log.info("GET /api/usuarios/activos - Usuarios activos");
                List<UsuarioSistemaListDTO> usuarios = usuarioService.findUsuariosActivos();

                return ResponseEntity.ok(
                                EntityResponse.success(usuarios, "Usuarios activos obtenidos",
                                                request.getRequestURI()));
        }
        ...
        public ResponseEntity<EntityResponse<List<UsuarioSistemaListDTO>>> getUsuariosByRol(
                ...
                return ResponseEntity.ok(
                                EntityResponse.success(usuarios, "Usuarios por rol obtenidos",
                                                request.getRequestURI()));
        }
}
