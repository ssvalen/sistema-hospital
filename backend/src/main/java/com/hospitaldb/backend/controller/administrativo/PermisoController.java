...
public class PermisoController {
        ...
        public ResponseEntity<EntityResponse<List<PermisoDTO>>> getAll(HttpServletRequest request) {
                ...
                return ResponseEntity.ok(
                                EntityResponse.success(permisos, "Permisos obtenidos exitosamente",
        ...
        public ResponseEntity<EntityResponse<PaginatedResponse<PermisoDTO>>> getAllPaginated(
                ...
                return ResponseEntity.ok(
                                EntityResponse.success(response, "Permisos obtenidos exitosamente",
                                                request.getRequestURI()));
        }
        ...
        public ResponseEntity<EntityResponse<PermisoDTO>> create(
                ...
                return ResponseEntity.status(HttpStatus.CREATED).body(
                                EntityResponse.success(created, "Permiso creado exitosamente",
                                                request.getRequestURI()));
        }
        ...
        public ResponseEntity<EntityResponse<PermisoDTO>> update(
                ...
                return ResponseEntity.ok(
                                EntityResponse.success(updated, "Permiso actualizado exitosamente",
                                                request.getRequestURI()));
        }
        ...
        public ResponseEntity<EntityResponse<Void>> delete(@PathVariable Long id, HttpServletRequest request) {
                ...
                return ResponseEntity.ok(
                                EntityResponse.success(null, "Permiso eliminado exitosamente",
                                                request.getRequestURI()));
        }
        ...
        public ResponseEntity<EntityResponse<List<PermisoDTO>>> getPermisosByUsuario(
                ...
                return ResponseEntity.ok(
                                EntityResponse.success(permisos, "Permisos del usuario obtenidos",
                                                request.getRequestURI()));
        }

        @GetMapping("/keycloak/{idKeycloak}")
        public ResponseEntity<EntityResponse<List<PermisoDTO>>> getPermisosByKeycloak(
                        @PathVariable String idKeycloak,
                        HttpServletRequest request) {

                log.info(
                                "GET /api/permisos/keycloak/{} - Obteniendo permisos",
                                idKeycloak);

                List<PermisoDTO> permisos = permisoService.findPermisosByIdKeycloak(idKeycloak);
