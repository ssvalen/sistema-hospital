...
public class OpenApiConfig {
        ...
        /**
         * Grupo: APIs ETl
         * Incluye: Carga y traslado de archivos para carga ETL
         */
        public GroupedOpenApi etlApi() {
                return GroupedOpenApi.builder()
                                .group("07 - ETL")
                                .displayName("Carga Masiva ETL")
                                .pathsToMatch("/api/hospitaldb/etl/**")
                                .addOpenApiCustomizer(openApi -> {
                                        openApi.getInfo().setDescription("""
                                                        Endpoints para procesos ETL.

                                                        ### Módulos incluidos:
                                                        - Carga de pacientes mediante CSV
                                                        - Carga de inventario mediante CSV
